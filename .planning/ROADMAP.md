...
- [ ] 05-02-PLAN.md — Wave 1: Drizzle schemas (scraper_config/runs/brand_aliases/fx_rates/scrape_cursors) + migration + CN alias seed + [BLOCKING] schema push
- [ ] 05-03-PLAN.md — Wave 1: Shared pure transforms (http/normalize/aliases) + types + redactSecrets
- [ ] 05-04-PLAN.md — Wave 2: Shared IO/stateful (images/block-detection/softdelete) + CBR FX feed + USS stub
- [ ] 05-05-PLAN.md — Wave 3: drom.ru/catalog populator + Cyrillic↔Latin auto-build + worker harness with 7 pg-boss schedules + admin metrics endpoint
- [ ] 05-06-PLAN.md — Wave 4a: Encar (Crawlee Playwright Firefox + IPRoyal KR) + Carapis fallback adapter + Day-3 D-03 checkpoint
- [ ] 05-07-PLAN.md — Wave 4b: BeForward (Cheerio, RU DC, no proxy per D-04)
- [ ] 05-08-PLAN.md — Wave 5: Che168 + Autohome (Crawlee Playwright Firefox + IPRoyal CN) + D-11 May 31 cutoff checkpoint
...
| 5. Inventory Pipeline (Encar + drom.ru/catalog + JP/CN scrapers) | 0/8 | Plans created | — |
